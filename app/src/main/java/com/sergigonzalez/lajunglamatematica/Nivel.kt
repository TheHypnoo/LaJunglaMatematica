    ...
    private fun whenSuma(){
        ...
        if(!finalSuma) {
            ...
            when (lvlSuma) {
                ...
                1 -> {
                    enunciadoNivel.text =
                            "A cambio de comprarle la fruta, mi mama me dio $numero1 euros así que los fui a meter en mi hucha. A más, yo ya tenía en mi hucha $numero2 euros." +
                                    " ¿Cuánto dinero tengo ahora en la hucha?"
                }
                2 -> {
            ...
            when (lvlDivision) {
                ...
                5 -> {
                    enunciadoNivel.text = "Después de ver la peli, me lavo los dientes y me voy a dormir. A la mañana" +
                            ...
                            "prepara mamá. Si en total hay preparadas $numero1 tortitas y somos $numero2 personas para" +
