...
class Pruebate : AppCompatActivity() {
    ...
    private fun Division (Signos:Array<String>) {
        ...
        if(!pruebateDivision) {
            ...
            while(
                    ((Number1TextView.text.toString().toInt().toDouble() % Number2TextView.text.toString().toInt().toDouble() != 0.0))
                    || ((Number3TextView.text.toString().toInt().toDouble() % Number4TextView.text.toString().toInt().toDouble() !=  0.0))
                    || ((Number5TextView.text.toString().toInt().toDouble() % Number6TextView.text.toString().toInt().toDouble() !=  0.0))
                    || ((Number7TextView.text.toString().toInt().toDouble() % Number8TextView.text.toString().toInt().toDouble() !=  0.0))
                    || ((Number9TextView.text.toString().toInt().toDouble() % Number10TextView.text.toString().toInt().toDouble() !=  0.0))
                    || ((Number11TextView.text.toString().toInt().toDouble() % Number12TextView.text.toString().toInt().toDouble() !=  0.0))
                    || ((Number13TextView.text.toString().toInt().toDouble() % Number14TextView.text.toString().toInt().toDouble() !=  0.0))
                    || ((Number15TextView.text.toString().toInt().toDouble() % Number16TextView.text.toString().toInt().toDouble() !=  0.0))
                    || ((Number17TextView.text.toString().toInt().toDouble() % Number18TextView.text.toString().toInt().toDouble() !=  0.0))
                    || ((Number19TextView.text.toString().toInt().toDouble() % Number20TextView.text.toString().toInt().toDouble() !=  0.0))
            ) {
                Number1TextView.text = generaNumeros().toString()
                Number2TextView.text = generaNumeros().toString()
                Number3TextView.text = generaNumeros().toString()
